 ...
 * @class DomAccess
 *
 * This class provides utility functions for interacting with the DOM (Document Object Model).
 * It helps to safely access and manipulate HTML elements, attributes, and data attributes
 * while performing checks to ensure valid nodes are being worked with.
 *
 * Key features include:
 * - Checking if an element is a valid HTML node.
 * - Retrieving, checking, and manipulating attributes and data attributes of HTML elements.
 * - Querying specific elements or lists of elements from a parent node.
 *
 * The methods in this class are designed with error handling in mind, providing strict mode options
 * to enforce the presence of required elements or attributes.
 *
 * @author Daouda Warme
 */
